...
main.innerHTML = kod
function opn(r){
    const firstIcon =  document.querySelector(`#first${r}`)
    const lastIcon =  document.querySelector(`#last${r}`)
    for (let i = 0; i < cars.length; i++) {
        firstIcon.style = 'none'
        lastIcon.style.display = 'initial'
...
const saytlar = document.querySelector('#saytlar')
const premium = document.querySelector('#salammeleyki')
function mobileFirst(){
    allMarkalar.classList.toggle('display')
    main.classList.toggle('display')
    hdr.classList.toggle('display')
    saytlar.classList.toggle('display')
    premium.classList.toggle('display')
